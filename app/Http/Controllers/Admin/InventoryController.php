...
class InventoryController extends Controller
{
    ...
    public function dataListing(Request $request)
    {
        ...
        $customcollections = Product::select('products.id',
        'productvariants.type' ,
        'productvariants.id as variant_id' ,
        'productvariants.inventory_quantity' ,
        'products.tax','productvariants.taxable_price',
        'productvariants.offer_price','productvariants.mrp_price' ,
        'products.name as title','products.category_id',
        'products.slug','product_images.image_name' ,
        'categories.name as category_name',
        'image_url', 'products.is_active')
