      ...
      $.ajax({
        ...
        .done(function (respons) {
          if(objectLength == 2)
          {
            ...
            $('.shop-product__buttons').children('a').attr('data-cart',$('#product_varient_details').text());
            var product_image = $('#product_varient_image').text();
            if(product_image != null){
              var varient_image = $('#slick_id_'+product_image).parent('div').parent('div').attr('data-slick-index');
