    ...
    <div class="">
      <div class="row g-0">
        ...
        <div class="col-12 col-lg-8 mt-lg-0 mt-4">
          <div class="card {{ $show ? 'header-div' : 'not_main_div' }}">
            @if ($show)
              ...
              <div class="card-body py-2">
                <div class="chat-messages px-4 py-2 scroll_div">
                  @if (!$messages)
              ...
              <div class="card-footer flex-grow-0 py-3 px-3 border-top">
