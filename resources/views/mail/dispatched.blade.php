                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px;padding-bottom:15px">
                                  <p
                                    ...
                                    Hey {{ ucwords($order->user->name) }}, <br>
                                    Your Order Is Dispatched.<br><br></p>
                                </td>
                              </tr>
                            </table>
                          </td>
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px">
                                  ...
                                  <p
                                    ...
                                    We’re excited to say that your {{ $order->order_number }} is shipped right now, with {{ ucwords($order->deleverd_to_name) }}, Tracking ID {{ $order->tracking_number }}. It’s estimated to arrive around
                                    {{ date('F j, Y', strtotime($order->deleverd_date)) }}.
                                  </p>
                                  <br />
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#000000;font-size:14px">
                                    Thank you for your patience, your precious gift will reach you soon. We look forward to serving you again with another amazingly creative gift experience.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
