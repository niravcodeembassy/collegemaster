          ...
          <table align="left" border="0" cellpadding="0" cellspacing="0" style="text-align: left;" width="100%">
            <tr>
              <td style="text-align: center;">
                <img class="editable-area" width="80%" id="logo" src="{{ $setting->logo }}" style="margin-bottom: 30px;width: 130px;" />
              </td>
            </tr>
            <tr>
              <td>
                <p style="font-size: 14px;"><b>Dear {{ $order->user->name ?? '' }} </b></p>
                <p style="font-size: 14px;line-height: 2;letter-spacing: 1px;">We would like to inform you that you order has been Waiting For Pictures </p>
              </td>
            </tr>
          </table>
            ...
            <tbody>
              <tr>
                <td style="background-color: #fafafa;border: 1px solid #ddd;padding: 15px;letter-spacing: 0.3px;width: 50%;">
                  <h5 style="font-size: 16px; font-weight: 600;color: #000; line-height: 16px; padding-bottom: 13px; border-bottom: 1px solid #e6e8eb; letter-spacing: -0.65px; margin-top:0; margin-bottom: 13px;">Shipping Address</h5>
                  <p style="text-align: left;font-weight: normal;margin-bottom:1px; font-size: 14px; color: #000000;line-height: 21px;    margin-top: 0;">
                    @if ($order->user->name)
                      {{ $order->user->name ?? '' }}
                    @endif
                  </p>
