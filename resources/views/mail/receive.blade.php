...
<head>
  ...
  <title>Order Waiting For Pictures</title>
...
<body style="width:100%;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
  <div class="es-wrapper-color" style="background-color:#F8EDEB">
    <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0"
      style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#F8EDEB">
      <tr>
          ...
          <table cellpadding="0" cellspacing="0" class="es-header" align="center"
            ...
            <tr>
              <td align="center" style="padding:0;Margin:0">
                <table bgcolor="#ffffff" class="es-header-body" align="center" cellpadding="0" cellspacing="0" background="{{ asset('front/assets/mail_images/33041613733668089.png') }}"
                  style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;background-repeat:no-repeat;width:600px;background-image:url('{{ asset('front/assets/mail_images/33041613733668089.png') }}');background-position:right top">
                  <tr>
                        ...
                        <tr>
                          <td class="es-m-p0r es-m-p20b" valign="top" align="center" style="padding:0;Margin:0;width:180px">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                              <tr>
                                <td align="left" style="padding:0;Margin:0;font-size:0px"><a target="_blank" href="{{ route('front.home') }}"
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#3D85C6;font-size:14px"><img
                                      src="{{ asset('front/assets/mail_images/no_space_logo.png') }}" alt="logo" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="170" height="53"></a>
                                </td>
                              </tr>
                            </table>
                          </td>
            ...
            <tr>
              <td align="center" style="padding:0;Margin:0">
                <table class="es-content-body"
                  style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#ffffff;background-repeat:no-repeat;width:600px;background-image:url('{{ asset('front/assets/mail_images/80931613657624134.png') }}');background-position:left 200px"
                  cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" background="{{ asset('front/assets/mail_images/80931613657624134.png') }}">
                  <tr>
                    <td align="left" style="padding:20px;Margin:0">
                      <!--[if mso]><table style="width:560px" cellpadding="0" cellspacing="0"><tr><td style="width:381px" valign="top"><![endif]-->
                      <table cellspacing="0" cellpadding="0" align="left" class="es-left" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
                        <tr>
                          <td class="es-m-p0r es-m-p20b" valign="top" align="center" style="padding:0;Margin:0;width:381px">
                      ...
                      <!--[if mso]></td><td style="width:40px"></td><td style="width:139px" valign="top"><![endif]-->
                      <table cellpadding="0" cellspacing="0" class="es-right" align="right" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:right">
                        <tr>
                          <td align="left" style="padding:0;Margin:0;width:139px">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                              <tr>
                                <td align="center" style="padding:0;Margin:0;font-size:0px"><img class="adapt-img" src="{{ asset('front/assets/mail_images/3557320200.png') }}" alt="image"
                                    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="139" height="139"></td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px">
                                  ...
                                  <p
                                    ...
                                    Welcome to the second stage of creating your perfect memory collage with Collage Master! We are happy to have you on board. Thank you for ordering
                                  <ol>
                                    @foreach ($order->items->pluck('name') as $item)
                                      <li
                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#000000;font-size:14px">
                                        {{ $item }}</li>
                                    @endforeach
                                  ...
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#000000;font-size:14px">
                                    We're waiting for your pictures. Gather together all the photographs you can find of the memory, event, or day you want a collage of and share them with us so that we may proceed towards designing your perfect
                                    memory collage! </p>
                                  <br />
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#000000;font-size:14px">
                                    We thank you so much for taking the time to choose our product! Please enjoy our products! Keep the most beautiful moments in a self-made memory photo collage by choosing Collage Master!</p>
                                </td>
                              </tr>
                            </table>
                          </td>
            ...
            <tr>
              <td align="center" style="padding:0;Margin:0">
                <table bgcolor="#ffffff" class="es-footer-body" align="center" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
                                    ...
                                    <tr>
                                      ...
                                      @if ($setting->response->pinterest)
                                        <td align="center" valign="top" style="padding:0;Margin:0">
                                          <a target="_blank" href="{{ $setting->response->pinterest }}"
                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#3D85C6;font-size:14px">
                                            <img title="Pinterest" src="{{ asset('front/assets/mail_images/pinterest-logo-black.png') }}" alt="P" width="32" height="32"
                  ...
                  <tr>
                    <td align="left" background="{{ asset('front/assets/mail_images/56371613733680508.png') }}"
                      style="padding:0;Margin:0;padding-bottom:20px;padding-left:20px;padding-right:20px;background-image:url('{{ asset('front/assets/mail_images/56371613733680508.png') }}');background-repeat:no-repeat;background-position:left bottom">
                      <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                        <tr>
                          <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
