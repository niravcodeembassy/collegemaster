...
<svg version="1.1"  width="{{ $width ?? "50px" }}" style="cursor: pointer;" class="zoom-in-zoom-out" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
    y="0px" viewBox="0 0 512.293 512.293" style="enable-background:new 0 0 512.293 512.293;" xml:space="preserve">
    <path style="fill:#8dc7f3;" d="M402.148,149.606C384.338,63.054,299.735,7.328,213.183,25.138
    ...
    <circle style="fill:#03a9f4;" cx="245.434" cy="373.136" r="117.333" />
    <g>
