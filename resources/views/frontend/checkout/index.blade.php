                                    ...
                                    <div id="billing-form" class="mb-40">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 mb-20">
                                                ...
                                                <input type="tel" placeholder="Phone number" value="{{ $shippingAddress->mobile ?? '' }}"  
                                                name="mobile" id="telephone" style="padding-left: 53px;" data-rule-required="true" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 mb-20">
                                             ...
                                             <div class="col-md-6 col-12 mb-20">
                                                ...
                                                value="{{ $sessionData['billing_mobile'] ?? '' }}" name="billing_mobile" id="billing_mobile"
                                                 data-rule-required="true" data-rule-required="#different_billing_address:checked" required pattern="^([0|\+[0-9]{1,5})?([7-9][0-9]{9})$" data-msg-required="Mobile no is required" data-rule-mobileUK="true" style="padding-left:73px!important;padding:10px">
                                                ...
                                                @if ($payment_setting->stripe_enable == 'Yes')
                                                    <div class="single-method">
                                                        <input type="radio" id="stripe" data-rule-required="true"
                                                            class="radio" name="payment_method" value="stripe">
