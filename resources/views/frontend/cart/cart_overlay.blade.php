@if (count($cartList) > 0 && isset($cartList))
  @php
    $subTotal = 0;
    ...
    @foreach ($cartList as $cart)
      ...
      <div class="single-cart-product">
        <span class="cart-close-icon">
          <a href="javascript:void(0)" data-url="{{ route('cart.remove') }}" class="add-to-cart-remove" data-id="{{ $cart->id }}"><i class="ti-close"></i></a>
        </span>
        <div class="image">
          <a href="{{ $route }}">
        ...
        <div class="content">
          ...
          <p><span class="cart-count">{{ $cart->qty ?? 0 }} x </span> <span class="discounted-price">{{ $priceData->price ?? $priceData->offer_price }}</span>
          </p>
        </div>
      </div>

      @php
        $subTotal += $cart->productvariant->final_price * $cart->qty;
      @endphp
    @endforeach
  </div>
  ...
  <p class="cart-subtotal">
    ...
    <span class="subtotal-amount">{{ Helper::priceFormate(number_format($subTotal, 2)) }}</span>
  </p>
...
@else
  <p class="text-center">
    <svg id="ffc6eb9a-0ec0-429c-85a8-ff38b44048bf" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="250" height="250" viewBox="0 0 896 747.97143">
      ...
      <path d="M747.41068,137.89028s14.61842,41.60627,5.62246,48.00724S783.39448,244.573,783.39448,244.573l47.22874-12.80193-25.86336-43.73993s-3.37348-43.73992-3.37348-50.14089S747.41068,137.89028,747.41068,137.89028Z"
      ...
      <path d="M714.339,210.43455l-25.60386,6.401L669.53227,329.91923s-6.401,29.87117,4.26731,32.00482S714.339,381.127,714.339,381.127s4.26731-32.00483,12.80193-32.00483L705.8044,332.05288,718.60633,257.375Z" transform="translate(-152 -76.01429)"
        fill="#3f3d56" />
