...
<div class="cart-product-container  ps-scroll">
  ...
  <div class="single-cart-product">
    <span class="cart-close-icon">
      <a href="javascript:void(0)" data-url="{{ route('cart.remove') }}" class="add-to-cart-remove"
        data-id="{{ $cart->id }}"><i class="ti-close"></i></a>
    </span>
    <div class="image">
      <a href="{{$route}}">
    ...
    <div class="content">
      ...
      <p><span class="cart-count">{{ $cart->qty ?? 0 }} x </span> <span class="discounted-price">{{ $priceData->price ??
          $priceData->offer_price }}</span>
      </p>
    </div>
  </div>
...
@else
<p class="text-center">
  <svg id="ffc6eb9a-0ec0-429c-85a8-ff38b44048bf" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="250"
    height="250" viewBox="0 0 896 747.97143">
    ...
    <path
      ...
      transform="translate(-152 -76.01429)" fill="#2f2e41" />
    <path d="M761.27943,758.78388v17.06924s-19.20289,46.39942,0,46.39942,34.13848,4.8083,34.13848-1.59266V763.05119Z"
      transform="translate(-152 -76.01429)" fill="#2f2e41" />
    <path d="M887.16508,758.75358v17.06924s19.20289,46.39941,0,46.39941-34.13848,4.80831-34.13848-1.59266V763.02089Z"
      transform="translate(-152 -76.01429)" fill="#2f2e41" />
