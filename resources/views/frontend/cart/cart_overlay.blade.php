...
<div class="cart-product-container  ps-scroll">
    ...
    <div class="single-cart-product">
        ...
        <div class="content">
            <h5><a
                    href="{{ route('product.details' , ['slug' =>  $cart->product->slug , 'variant' => $cart->productvariant->id]) }}">{{ $cart->product->name }}</a>
            </h5>
            <p><span class="cart-count">{{ $cart->qty ?? 0 }} x </span> <span
                    class="discounted-price">{{ $priceData->price ?? $priceData->offer_price  }}</span>
            </p>
        </div>
    </div>
