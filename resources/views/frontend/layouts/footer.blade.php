                ...
                <div class="col-lg-6 col-md-12 right">
                    <div class="signup-form">
                        <form id="mc-form" action="{{ route('newsletter') }}" class="mc-form">
                            <div class="form"><input type="email" placeholder="Your Email" required
                                    id="newsletter_email" data-rule-required="true" name="email">
                                <input type="submit">
                            </div>
            ...
            <div class="row clearfix footer_grid mx-xl-5 mx-2">
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 footer-single-widget">
                    ...
                    <div class="footer-subscription-widget">
                        ...
                        <p class="about marginB20">
                            Call at
                            <a href="tel:{{ $frontsetting->contact }}" class=""
                                style="color: rgb(252, 88, 47);">{{ $frontsetting->contact }}</a><br>
                            ...
                            <section class="f-50">
                                ...
                                <ul class="footer-links list-inline social-link">
                                    ...
                                    @if ($frontsetting->instagram)
                                        <li><a href="{{ $frontsetting->instagram }}"> <i
                                                    class="fa fa-instagram"></i></a></li>
                                    @endif
                                    @if ($frontsetting->whatsapp)
                                        <li><a href="{{ $frontsetting->whatsapp }}"> <i
                                                    class="fa fa-whatsapp"></i></a>
                                        </li>
                                    @endif
                                    @if ($frontsetting->linkedin)
                                        <li><a href="{{ $frontsetting->linkedin }}"> <i
                                                    class="fa fa-linkedin"></i></a>
                                        </li>
                                    @endif
                                    @if ($frontsetting->twitter)
                                        <li><a href="{{ $frontsetting->twitter }}"> <i class="fa fa-twitter"></i></a>
                                        </li>
                                    @endif
                                    @if ($frontsetting->pinterest)
                                        <li><a href="{{ $frontsetting->pinterest }}"> <i
