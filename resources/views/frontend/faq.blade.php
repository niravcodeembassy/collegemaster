                    ...
                    <div class="card-header bg-gradient-primary p-5 position-relative">
                        ...
                        <div class="position-absolute w-100 z-index-1 bottom-0 ms-n5">
                            <svg class="waves" xmlns="http://www.w3.org/2000/svg"
                                ...
                                shape-rendering="auto" style="height:7vh;min-height:50px;">
                                <defs>
                                    <path id="gentle-wave"
                                        ...
                                        @foreach ($item->children as $key => $child)
                                            <div class="accordion-item mb-3">
                                                <h5 class="accordion-header" id="headingOne">
                                                    <button
                                                        class="accordion-button collapsed border-bottom font-weight-bold"
                                                        data-toggle="collapse" id="headingOne"
                                                        href="#collapseOne{{ $child->id }}">
                                                        {{ $child->question }}
                                                    </button>
                                                </h5>
                                                <div id="collapseOne{{ $child->id }}" class="accordion-collapse collapse"
