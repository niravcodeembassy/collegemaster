                            ...
                            <div class="font-size-div">
                                ...
                                <div class="cos-section-wrapper">
                                  <div class="cos-column"><span class="cos-column-title"><b>Place of Supply :
                                    ...
                                    <div class="cos-column"><span class="cos-column-title"><b>State of Supply :
                                            </b></span><span>{{ $setting->state }}</span></div>
                                </div>
                                          ...
                                          @endphp
                                            @foreach ($order->items as $item)
                                                ...
                                                <tr class="large-item-row gst-invoice">
                                                    ...
                                                    <td class="" width="10">{!! Helper::showPrice($data->qty_price,$order->currency,$order->currency) !!}</td>
                                                    ...
                                                    <td class="" width="10">{!! Helper::showPrice(($data->tax / 2),$order->currency,$order->currency) !!}</td>
                                                    <td class="" width="10">{!! Helper::showPrice(($data->tax / 2),$order->currency,$order->currency) !!}</td>
                                ...
                                <div class="invoice-terms-wrapper">
                                    ...
                                    <ol class="invoice-terms">
                                        <li>Please pay within 15 days from the date of invoice, overdue interest @ 14% will be
                                            charged on
                                            delayed payments.</li>
