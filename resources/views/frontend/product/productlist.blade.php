        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 border-bottom category_list">
                    @if (request('term'))
                        <h1 class="text-center text-uppercase font-weight-bold pb-3">
                            <span>{{ ucwords(request('term')) }}</span>
                        </h1>
                    @else
                        <h1 class="text-center text-uppercase font-weight-bold pb-3">
                        ...
                        @isset($category->description)
                            <div class="pb-3 small_text"> {!! Str::limit($str, 300, '') !!}
                                <a class="read_more font-weight-bold">Read more...</a>
                            </div>
                            <div class="pb-3 fulltext d-none">
                                {!! $str !!}
            ...
            <div class="shop-page-content mb-100 mt-sm-10 mb-sm-10">
                <div class="{{ request('term') !== null || request('flag') == 'false' ? 'container' : 'container wide' }}">
                    <div class="row">
                            ...
                            <div class="col-lg-3 order-1 order-lg-2 mb-md-80 mb-sm-20">
                                ...
                                <div class="page-sidebar">
                                    ...
                                    <div class="single-sidebar-widget mb-40 d-none">
                                        ...
                                        <input type="text" class="js-range-slider" data-min="{{ 1 }}"
                                            data-max="{{ $max ?? 5000 }}" name="range"
                        ...
                        @endif
                        <div
                            class="{{ request('term') !== null || request('flag') == 'false' ? 'col-lg-12' : 'col-lg-9' }} order-1 order-lg-2 mb-md-80 mb-sm-80">
                            @php
                                $type = 'list';
                            ...
                            <div class="row product-isotope shop-product-wrap {{ $type }} ">
                                @foreach ($product as $item)
                                    <!--=======  single product   =======-->
                                    <div
                                        class="mb-45 sale {{ request('type') == 'grid-four' || request('term') !== null || request('flag') == 'false' ? 'col-lg-3 col-12 col-md-6 col-sm-6' : 'col-lg-4 col-12 col-md-6 col-sm-6 responsive_list ' }}">
                                ...
                                @if ($product->count() === 0)
                                    <div class="text-center mx-auto">
                                        ...
                                        <svg id="9af98f83-10c5-4067-bc84-20554b2827d8" data-name="Layer 1"
                                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                            width="350" height="350" viewBox="0 0 1009.54 789.93">
                                            <defs>
                                                <linearGradient id="07c62293-c0d3-4921-8e06-4e39241449cd" x1="318.22"
                                                    y1="488.45" x2="630.35" y2="488.45"
                                            ...
                                            <title>empty</title>
                                            <ellipse cx="354.13" cy="741.27" rx="176.1" ry="33.36"
                                            ...
                                            <polygon points="317.24 201 332.49 219.34 330.5 237.85 312.07 209 317.24 201"
                                                fill="#dce6f2" />
                                            <polygon
                                            ...
                                            <path d="M398.13,310.45s-7,17-12.25,19.75S400.63,336,398.13,310.45Z"
                                                transform="translate(-95.23 -55.03)" opacity="0.1" />
                                            <path d="M403.38,342.2s-16,2-16,5S403.38,342.2,403.38,342.2Z"
                                                transform="translate(-95.23 -55.03)" opacity="0.1" />
                                            ...
                                            <path
                                                ...
                                                transform="translate(-95.23 -55.03)" fill="#6c63ff" />
                                            <ellipse cx="698.97" cy="716.3" rx="26.93" ry="4.55"
                                                fill="#6c63ff" opacity="0.1" />
                                            <ellipse cx="600.8" cy="785.38" rx="26.93" ry="4.55"
                                                fill="#6c63ff" opacity="0.1" />
                                            <ellipse cx="93.14" cy="749.99" rx="26.93" ry="4.55"
                                                fill="#6c63ff" opacity="0.1" />
                                            <ellipse cx="805.06" cy="780.83" rx="26.93" ry="4.55"
                                                fill="#6c63ff" opacity="0.1" />
                                            <ellipse cx="833.1" cy="723.1" rx="40.21" ry="6.8"
                                                fill="#6c63ff" />
                                            <path
