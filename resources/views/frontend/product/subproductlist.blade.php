                ...
                <div class="col-lg-12 border-bottom category_list">
                    ...
                    @else
                        ...
                        @isset($subCategory->description)
                            <div class="pb-3 small_text"> {!! Str::limit($str, 250, '') !!}
                                <a class="read_more font-weight-bold">Read more...</a>
                            </div>
                            <div class="pb-3 fulltext d-none">{!! $str !!}
                ...
                <select class="nice-select w-100" name="sort" id="sort">
                  ...
                  <option value="high" {{ request('sort')=='high' ? 'selected' : '' }}>Sort by price: high to low
                                ...
                                <div class="single-icon advance-filter-icon d-lg-none">
                                    <a href="javascript:void(0)" id="offcanvas-category-icon" class=""><i
            ...
            <div class="shop-page-content mb-100 mt-sm-10 mb-sm-10">
                <div class="{{ request('term') !== null || request('flag') == 'false' ? 'container' : 'container wide' }}">
                    <div class="row">
                        ...
                        @endif
                        <div
                            class="{{ request('term') !== null ? 'col-lg-12' : 'col-lg-9' }} order-1 order-lg-2 mb-md-80 mb-sm-80">
                            @php
                                $type = 'list';
