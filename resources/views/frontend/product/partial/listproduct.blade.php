<div class="single-product--list">
        ...
        <div class="single-product__floating-icons">
            <span class="wishlist">
                @auth
                    ...
                    <a href="javascript:void(0)" class="has-wish-lists bg-danger" data-tippy="Add to wishlist" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder" data-tippy-placement="left"
                        data-url="{{ route('wishlist.add.remove',['variant_id' => $product->variant_id]) }}">
                        <i class="ion-android-favorite-outline text-white"></i>
                    </a>
                    @else
                    <a href="javascript:void(0)" class="has-wish-lists" data-tippy="Add to wishlist" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder" data-tippy-placement="left"
                        data-url="{{ route('wishlist.add.remove',['variant_id' => $product->variant_id]) }}">
    ...
    <div class="single-product__content">
        ...
        <a href="{{ route('product.details' , ['slug' => $product->slug ]) }}" class="lezada-button lezada-button--medium">VIEW PRODUCT</a>
