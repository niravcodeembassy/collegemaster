<div class="single-product">
        ...
        <div class="single-product__floating-icons">
            <span class="wishlist">
                @auth
                    ...
                    @else
                        <a href="javascript:void(0)" class="has-wish-lists" data-tippy="Add to wishlist"
                            data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50"
                            data-tippy-arrow="true" data-tippy-theme="sharpborder" data-tippy-placement="left"
                            data-url="{{ route('wishlist.add.remove', ['variant_id' => $product->variant_id]) }}">
                ...
                @else
                    <a href="{{ route('login') }}" class="" data-tippy="Add to wishlist" data-tippy-inertia="true"
                        ...
                        data-tippy-theme="sharpborder" data-tippy-placement="left" data-url="#">
                        <i class="ion-android-favorite-outline"></i>
                    </a>
                @endauth
            </span>
    ...
    <div class="single-product__content">
        <div class="title">
            <h3>
                <a href="{{ $route }}">{{ Str::limit($product->name, rand(50, 55), '...') }}</a>
            </h3>
            <a href="{{ $route }}">
                VIEW PRODUCT
            </a>
        ...
        <div class="price">
            <span class="main-price"
                style="font-size: 16px; color: #ad0101 !important;">{{ 'US' . $priceData->price . '+' }}</span>
            @if ($priceData->offer_price)
                <span class="main-price discounted"
                    style="font-size: 12px;">{{ 'US' . $priceData->offer_price . '+' }}</span>
