...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-area pb-20">
                        <ul class="breadcrumb-list">
                            ...
                            <li
                                class="breadcrumb-list__item {{ is_null($product->subcategory) ? 'breadcrumb-list__item--active text-uppercase' : 'text-uppercase' }}">
                                <a
                                    href="{{ route('category.product', $product->category->slug) }}">{{ strtoupper($product->category->name) }}</a>
                            </li>
                            @php
                ...
                <div class="col-lg-12">
                        ...
                        <div class="row pb-100">
                                ...
                                <div class="shop-product__big-image-gallery-wrapper mb-30">
                                    ...
                                    <div class="shop-product-rightside-icons">
                                        ...
                                        <span class="enlarge-icon">
                                            <a class="btn-zoom-popup p-1" href="#" data-images="{{ $images_list }}"
                                    ...
                                    <div class="shop-product__big-image-gallery-slider lazy">
                                        ...
                                        @foreach ($images as $key => $item)
                                            <div class="single-image main_big_img" id="slick_image_id_{{ $item->id }}">
                                                <img src="{{ $item->variant_image }}" class="img-fluid"
                                                    alt="{{ $item->image_alt ?? '' }}"
                            ...
                            <div class="col-lg-6">
                                <div class="shop-product__description shop-product-url"
                                    data-url="{{ route('product.view', $product->slug) }}">
                                    ...
                                    <div class="align-items-center d-flex mb-25 shop-product__price">
                                        <div class="d-flex flex-wrap w-55">
                                            ...
                                            @if ($priceData->offer_price)
                                                <span
                                                    class="main-price discounted">{{ 'US' . $priceData->offer_price . '+' }}</span>
                                                <span class="discount-percentage">({{ intval($priceData->dicount) }}%
                                                    Off)</span>
                                            @endif
                                            <p class="content_h1"><span class="content_h2">HOORAY!</span> This item delivers
                                                for free.</p>
                                        </div>
                                        <img src="{{ asset('front/assets/images/stock.png') }}" class="stock img-fluid"
                                            alt="item in stock" title="item in stock">
                                    </div>
                                        ...
                                        <div id="block-varient">
                                            @foreach ($variatoinList as $key => $variatoins)
                                                <div class="form-group mb-25">
                                                    ...
                                                    @endphp
                                                    <label for="variatoins_{{ $key }}"
                                                        class="d-block shop-product__block__title"><b>{{ ucfirst($option->name) }}</b>
                                                        <span class="text-danger">*</span></label>
                                                    <div class="d-block clearfix " style="width: 30%;">
                                                        <select name="variatoins" class="form-control change-combination "
                                                            id="variatoins_{{ $key }}" style="width: 350px;">
                                            ...
                                            <div class="shop-product-color-list">
                                                ...
                                                <ul class="single-filter-widget--list single-filter-widget--list--color">
                                                    <li class="mb-0 pt-0 pb-0 mr-10"><a class="active"
                                                            href="#"><span class="color-picker black"></span></a>
                                                    </li>
                    ...
                    @endauth --}}
                                        ...
                                        <div class="shop-product__buttons mb-40 d-flex">
                                            <a class="lezada-button lezada-button--medium add-to-cart mr-3"
                                                href="javascript:void(0)" data-cart="{{ json_encode($cart) }}"
                                                data-url="{{ route('cart.add') }}">add to cart</a>
                                            <div class="d-flex tooltip_truck"
                                                data-tippy="{{ $frontsetting->delivery_caption ?? '' }}"
                                                data-tippy-placement="top" data-tippy-inertia="true"
                                                data-tippy-animation="shift-away" data-tippy-delay="50"
                                                data-tippy-arrow="true">
                                                <a href="javascript:void(0)" class="ml-2 mr-3">
                                                    <img src="{{ asset('front/assets/images/truck.png') }}"
                                                        alt="delivery information" title="delivery information"
                                                        class="delivery_truck img-fluid">
                                                </a>
                                            ...
                                            <tr class="single-info">
                                                ...
                                                <td class="quickview-value">
                                                    <ul class="quickview-social-icons">
                                                        <li><a href="{{ $social_link['facebook'] }}" target="_blank"><i
                                                                    class="fa fa-facebook"></i></a></li>
                                                        <li><a href="{{ $social_link['twitter'] }}" target="_blank"><i
                                                                    class="fa fa-twitter"></i></a></li>
                                                        <li><a href="{{ $social_link['whatsapp'] }}" target="_blank"><i
                                                                    class="fa fa-whatsapp"></i></a></li>
                                                        <li><a href="{{ $social_link['linkedin'] }}" target="_blank"><i
                                                                    class="fa fa-linkedin"></i></a></li>
                                                        <li><a href="{{ $social_link['pinterest'] }}" target="_blank"><i
                                                                    class="fa fa-pinterest"></i></a></li>
                                                        <li>
                                                            <a href="javascript:void(0)" id="kt_clipboard_3"
                                                                class="copy_link"
                                                                data-clipboard-text="{{ url()->current() }}"
                                                                data-tippy="Copy Link" data-tippy-placement="right"
                                                    ...
                                                    <div class="share">
                                                        <span class="socials">
                                                            <a href="https://www.facebook.com/sharer.php?u=https://demo4.drfuri.com/razzi/shop/blazer-coupe-amincie/"
                                                                target="_blank" class="social-share-link facebook"><span
                                                                    class="svg_icon "><svg aria-hidden="true"
                                                                        role="img" focusable="false" width="24"
                                                                        height="24" viewBox="0 0 7 12"
                                                                        fill="currentColor"
                                                                    ...
                                                                    </svg></span><span class="after-text d-none">Share on
                                                                    Facebook</span></a><a
                                                                ...
                                                                target="_blank"
                                                                class="social-share-link twitter mx-2"><span
                                                                    class="svg_icon "><svg aria-hidden="true"
                                                            ...
                                                            <a href="https://www.pinterest.com/pin/create/button/?description=Blazer%20Coupe%20Amincie&amp;media=https://i0.wp.com/demo4.drfuri.com/razzi/wp-content/uploads/sites/14/2020/10/m11.jpg?fit=1000%2C1200&amp;ssl=1&amp;url=https://demo4.drfuri.com/razzi/shop/blazer-coupe-amincie/"
                                                                target="_blank" class="social-share-link pinterest"><span
                                                                    class="svg_icon "><svg aria-hidden="true"
                                                                        role="img" focusable="false" width="24"
                                ...
                                <div class="shop-product__description-tab pt-30 mb-100">
                                    ...
                                    <div
                                        ...
                                        <div class="nav nav-tabs justify-content-center flex-lg-row" id="nav-tab2"
                                            role="tablist">
                                            <a class="nav-item nav-link active text-uppercase" id="product-tab-1"
                                                data-toggle="tab" href="#product-series-1" role="tab"
                                                aria-selected="true">Description</a>
                                            <a class="nav-item nav-link text-uppercase" id="product-tab-2"
                                                data-toggle="tab" href="#product-series-2" role="tab"
                                                aria-selected="false">Specification
                                            </a>
                                            <a class="nav-item nav-link text-uppercase" id="product-tab-3"
                                    ...
                                    <div class="tab-content" id="nav-tabContent2">
                                        ...
                                        <div class="tab-pane fade active show" id="product-series-1" role="tabpanel"
    ...
    <!-- Modal -->
    <div class="modal fade" id="modelReview" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        aria-hidden="true">
