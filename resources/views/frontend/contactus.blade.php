                    ...
                    <form id="contact-form"
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-40">
                                <input type="text" name="name" placeholder="First Name *" id="customername"
                                    required="">
                            </div>
                            <div class="col-md-4 mb-40">
                            ...
                            <div class="col-md-4 mb-40">
                                <input type="text" name="mobile" min="10" max="10" placeholder="Mobile Number *" name="mobile" id="mobile"
                                    required="">
                            </div>
                            ...
                            <div class="col-lg-12 text-right">
                                <button
                                  type="submit"
                                  data-sitekey="6LchyE0aAAAAABk2zPeUNVWNceekKtmUlK8YJ5Zw"
                                  data-callback='onSubmit'
                                  class="g-recaptcha lezada-button lezada-button--medium"
