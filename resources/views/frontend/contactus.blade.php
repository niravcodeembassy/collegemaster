...
@section('content')
    <div class="auth-header min-vh-100">
        <div>
            ...
            <div
                class="col-6 image_content d-lg-flex d-none w-50 z-index-0 d-sm-none d-md-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
                <div
                    class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center">
                    <img src="{{ asset('front/assets/images/pattern-lines.svg') }}" alt="pattern-lines" title="pattern-lines"
            ...
            <div class="row">
                <div class="col-lg-7 d-flex justify-content-center mt-lg-0 mt-4 flex-column">
                    <div class="card d-flex blur justify-content-center p-4 shadow-lg my-sm-0 my-sm-6 mt-8 mb-5">
                        ...
                        <form id="contact-form" class="auth_form" method="post" autocomplete="off"
                            action="{{ route('contact-us.stroe') }}">
                            @csrf
                            <div class="card-body pb-2">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="name" class="form-control form-control-lg"
                                                placeholder="First Name" id="customername">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label>Email </label>
                                        <div class="input-group">
                                            <input type="email" class="form-control form-control-lg" name="email"
                                                placeholder="Email" data-rule-email="true">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <button type="submit"
                                            class="auth_btn btn text-uppercase text-white bg-gradient-primary  w-100 mt-4 mb-0">
                                            Send Message
                                        </button>
                                    </div>
                                </div>
