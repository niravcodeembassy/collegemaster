                ...
                <div class="col-lg-9 col-md-12">
                  <div class="tab-pane fade active show" id="profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    ...
                    <div class="card-body lezada-form contact-form p-0">
                      <form action="{{ route('profile.update', $user->id) }}" class="form-horizontal" name="update_profile_form" id="update_profile_form" enctype="multipart/form-data" method="POST" data-url="{{ route('mailcheck') }}"
                        data-id="{{ $user->id }}">
                        @method('put')
                        @csrf()
                        ...
                        <div class="row">
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" class="" name="first_name" id="first_name" data-rule-required="true" data-msg-required="First Name is required" value="{{ $user->first_name ?? '' }}">
                          </div>
                          <div class="form-group col-md-6">
                          ...
                          <div class="form-group col-md-6 col-12 mb-20">
                            ...
                            <select class="nice-select" placeholder="Country" name="country" style="display: none;" id="country">
                              ...
                              @foreach ($countryList as $item)
                                <option value="{{ $item->id }}" {{ isset($user->country_id) && strtolower($user->country_id) == strtolower($item->id) ? 'selected' : '' }}>
                                  {{ $item->name }}</option>
                              @endforeach
                            </select>
                          </div>
