                                ...
                                <div class="profiletimeline">
                                    @foreach ($customer->orders as $item)
                                        <div class="sl-item">
                                            ...
                                            <div class="sl-right">
                                                <a href="{{ route('orders.show', $item->id) }}" class="link call-modals"
                                                    data-url="{{ route('orders.show', $item->id) }}"
                                                    data-target-modal="#orderdetails" data-target="#orderdetails"> Order No
                                                    :
                                                    {{ $item->order_number ?? '---' }}
                                                    | Date : <span
                                                        class="sl-date text-behance">{{ $item->created_at->format('m-d-Y H:i:s') ?? '---' }}
                                                        (IST)
                                                    </span>
                                                    <a class="lezada-button lezada-button--medium cus_view_order ml-3"
                                                        href="{{ route('orders.show', $item->id) }}">VIEW ORDER</a>
        ...
        <div class="modal-dialog" style="max-width:1080px;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <i class="ti-close pt-2" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"
                            data-msg-required="Category is required."></i>
