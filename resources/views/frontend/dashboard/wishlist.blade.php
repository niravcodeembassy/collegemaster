              ...
              <div class="col-12 col-md-6 col-sm-6 mb-45 sale col-lg-4">
                <div class="single-product">
                  ...
                  <div class="single-product__image">
                    ...
                    <a class="image-wrap" href="{{ route('product.details' ,$routeParameter) }}">
                    ...
                    <div class="single-product__floating-icons">
                      <span class="wishlist">
                        ...
                        <a href="javascript:void(0)" class="has-wish-lists bg-danger" data-remove="true"
                          data-url="{{ route('wishlist.add.remove',['variant_id' => $product->variant_id]) }}">
                          <i class="ion-android-favorite-outline text-white"></i>
                        </a>
                        @else
                        <a href="javascript:void(0)" class="has-wish-lists"
                          data-url="{{ route('wishlist.add.remove',['variant_id' => $product->variant_id]) }}">
                  ...
                  <div class="single-product__content">
                    <div class="title">
                      <h3>
                        <a href="{{ route('product.details' ,$routeParameter += ['variant' => $product->variant_id]) }}">{{
                          $product->name }}</a>
                      </h3>
                      <a href="{{ route('product.details' ,$routeParameter += ['variant' => $product->variant_id]) }}">
                        VIEW PRODUCT
