                                ...
                                <div style="width:100%">
                                    <form name="orderMsgForm" id="orderMsgForm">
                                        ...
                                        <div class="form-group" >
                                            ...
                                            placeholder="Write your query regarding to order..."
                                             cols="30" rows="10"></textarea>
                                            
                                        </div>
                                        <button class="btn btn-md btn-info mb-2 float-right" id="msg_send_btn" type="submit"
                                        > Send<i
                                            class="ion-android-send ml-2 "></i></button> <br>
