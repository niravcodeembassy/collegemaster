                            ...
                            <form class="auth_form" method="POST" action="{{ route('login') }}" autocomplete="off">
                                ...
                                <div class="mb-3">
                                    <input id="password" type="password"
                                        ...
                                        name="password" required autofocus placeholder="Password" aria-label="Password">
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                      ...
                      {{ __('Remember Me') }}
                        ...
                        <div class="card-footer text-center pt-0 px-lg-2 px-1">
                            <p class="mb-4 text-sm mx-auto">
                                ...
                                <a href="{{ route('register') }}" class="text-dark text-gradient font-weight-bold">Sign
                                    up</a>
                            </p>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="mx-auto text_content">
                            ...
                            <p class="text-white">The more effortless the writing looks, the more effort the writer actually
