                ...
                <div class="col-xl-5 col-lg-6 col-md-9 d-flex flex-column mx-auto">
                    <div class="card z-index-0 mt-sm-12 mt-9 mb-4">
                        <div class="card-header text-center pt-4 pb-1">
                            <h1 class="font-weight-bolder mb-1">Reset password</h1>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" class="password_form" action="{{ route('password.email') }}"
                                id="forgotpassword">
                                @csrf
                                <div class="mb-3">
                                    <input type="email"
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="auth_btn btn text-uppercase text-white bg-gradient-primary  w-100 my-2 mb-2">
                                        Send
                                    </button>
                                </div>
                            </form>
