    ...
    <div class="auth-header min-vh-100">
        <div class="container">
            <div class="row">
                    ...
                    <div class="card auth_card card-plain">
                            ...
                            <form class="auth_form" method="POST" action="{{ route('register') }}" id="register_form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3">
                                            <input id="email" type="email" data-rule-email="true"
                                    ...
                                    <div class="col-md-12 w-100">
                                        ...
                                        <div class="intel_input">
                                            <input id="mobile" type="text" placeholder="Mobile number" number="true"
                                                class="form-control telephone form-control-lg @error('mobile') is-invalid @enderror"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div>
                                            <select class="nice-select form-control  form-control-lg  w-100"
                                                data-rule-required="true" placeholder="Country" name="country_id"
                                                id="country">
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="auth_btn text-uppercase btn text-white bg-gradient-primary w-100 mt-4 mb-0">Sign
                                        up</button>
                                </div>
                            </form>
                        </div>
                        <div class="card-footer text-center pt-0 px-sm-4 px-1">
                            <p class="mb-4 mx-auto">
                                ...
                                <a href="{{ route('login') }}" class="text-dark text-gradient font-weight-bold">Sign
                                    in</a>
                            </p>
                        </div>
                    </div>
                ...
                <div
                    class="col-6 image_content d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
                    <div
                        class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center">
                        <img src="{{ asset('front/assets/images/pattern-lines.svg') }}" alt="pattern-lines"
                            title="pattern-lines" class="position-absolute opacity-4 start-0">
                        <div class="position-relative">
                            <img class="max-width-500 w-100 position-relative z-index-2"
                                src="{{ asset('front/assets/images/chat.png') }}" alt="image" title="image">
                        </div>
                        <div class="mx-auto text_content">
                            <h4 class="text-white font-weight-bolder">Your journey starts here</h4>
                            <p class="text-white">Just as it takes a company to sustain a product, it takes a community to
                                sustain a protocol.</p>
                        </div>
                    </div>
                </div>
            </div>
