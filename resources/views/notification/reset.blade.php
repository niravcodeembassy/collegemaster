...
<head>
  ...
  <style type="text/css">
    ...
    td .es-button-border-2:hover {
      background: #2b2b2c !important;
      border-color: #5b657b #5b657b #5b657b #5b657b !important;
    }
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr style="border-collapse: collapse">
                                <td align="center" style="
                                      ...
                                      font-size: 0px;
                                    ">
                                  <img class="adapt-img" src="{{ asset('front/assets/mail_images/collagemaster_logo.png') }}" alt
                                    style="
                                        display: block;
                                        border: 0;
                                        outline: none;
                          ...
                          <td align="left" style="padding: 0; margin: 0; width: 270px">
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr class="es-mobile-hidden" style="border-collapse: collapse">
                                <td class="es-m-txt-c h-auto es-m-p40" align="center" height="49" style="padding: 0; margin: 0">
                                  <span class="es-button-border-2 es-button-border"
                                    style="
                                        ...
                                        width: auto;
                                      "><a
                                      href="{{ route('login') }}" class="es-button es-button-1" target="_blank"
                                      style="
                                          mso-style-priority: 100 !important;
                                          text-decoration: none;
                                          -webkit-text-size-adjust: none;
                              ...
                              <tr style="border-collapse: collapse">
                                <td align="center"
                                  style="
                                      ...
                                      font-size: 0;
                                    ">
                                  <img src="{{ asset('front/assets/mail_images/23891556799905703.png') }}" alt
                                    style="
                                        display: block;
                                        border: 0;
                                        outline: none;
                                ...
                                <td align="center"
                                  ...
                                  <p
                                    style="
                                      ...
                                      font-size: 16px;
                                    ">
                                    HI,&nbsp;<strong>{{ ucwords($user->first_name) . ' ' . ucwords($user->last_name) }}</strong>
                                  </p>
                                </td>
                              </tr>
                              <tr style="border-collapse: collapse">
                              ...
                              <tr style="border-collapse: collapse">
                                <td align="center"
                                  ...
                                  <p
                                    ...
                                    Otherwise, please click the button below to verify email address
                                  </p>
                                </td>
                              </tr>
                              <tr style="border-collapse: collapse">
                                <td align="center"
                                  style="
                                      ...
                                      padding-bottom: 40px;
                                    ">
                                  <span class="es-button-border-5 es-button-border"
                                    style="
                                        border-style: solid;
                                        border-color: #3d5ca3;
                                        background: #2b2b2c;
                                        ...
                                        width: auto;
                                      "><a
                                      href="{{ $url }}" class="es-button es-button-4" target="_blank"
                                      style="
                                          mso-style-priority: 100 !important;
                                          text-decoration: none;
                                          -webkit-text-size-adjust: none;
                                    ...
                                    <tr style="border-collapse: collapse">
                                      @if ($setting->facebook)
                                        <td valign="top" align="center"
                                          ...
                                          <a href="{{ $setting->facebook }}" target="_blank">
                                            <img src="{{ asset('front/assets/mail_images/facebook-square-black.png') }}" alt="Fb" title="Facebook" width="32" height="32"
                                              style="
                                              display: block;
                                              border: 0;
                                              outline: none;
                                      ...
                                      @if ($setting->twitter)
                                        <td valign="top" align="center"
                                          ...
                                          <a href="{{ $setting->twitter }}" target="_blank">
                                            <img src="{{ asset('front/assets/mail_images/twitter-square-black.png') }}" alt="Tw" title="Twitter" width="32" height="32"
                                              style="
                                              display: block;
                                              border: 0;
                                              outline: none;
                                      ...
                                      @if ($setting->instagram)
                                        <td valign="top" align="center"
                                          ...
                                          <a href="{{ $setting->instagram }}" target="_blank">
                                            <img src="{{ asset('front/assets/mail_images/instagram-square-black.png') }}" alt="Ig" title="Instagram" width="32" height="32"
                                              style="
                                              display: block;
                                              border: 0;
                                              outline: none;
                                      ...
                                      {{-- <td valign="top" align="center"
                                        style="
                                            ...
                                            padding-right: 10px;
                                          ">
                                        <img src="{{ asset('front/assets/mail_images/youtube-square-black.png') }}" alt="Yt" title="Youtube" width="32" height="32"
                                          style="
                                              display: block;
                                              border: 0;
                                              outline: none;
                                      ...
                                      @if ($setting->pinterest)
                                        <td valign="top" align="center" style="padding: 0; margin: 0">
                                          <a href="{{ $setting->pinterest }}" target="_blank">
                                            <img src="{{ asset('front/assets/mail_images/pinterest-square-black.png') }}" alt="P" title="Pinterest" width="32" height="32"
                                              style="
                                              display: block;
                                              border: 0;
                                              outline: none;
                                    ...
                                    <a target="_blank"
                                      style="
                                          ...
                                          font-family: 'open sans',
                                            ...
                                            sans-serif;
                                        "
                                      href="tel:{{ $setting->contact }}">{{ $setting->contact }}</a>|
                                ...
                                <td align="left"
                                  ...
                                  <h2
                                    style="
                                        ...
                                        color: #333333;
                                      ">
                                    <b style="color: #333333; font-size: 16px">Have Q</b><span style="font-size: 16px"><b>uestions</b></span><b style="color: #333333; font-size: 16px">?</b>
                                  </h2>
                                </td>
                              </tr>
                              <tr style="border-collapse: collapse">
                                <td align="left"
                                  ...
                                  <p
                                    style="
                                        ...
                                        font-size: 14px;
                                      ">
                                    We are here to help, learn more about us
                                    <a target="_blank"
                                      style="
                                          -webkit-text-size-adjust: none;
                                          -ms-text-size-adjust: none;
                                    ...
                                    <tr class="links" style="border-collapse: collapse">
                                      <td
                                        style="
                                            ...
                                            border: 0;
                                          "
                                        id="esd-menu-id-0" width="33.33%" valign="top" bgcolor="transparent" align="center">
                                      ...
                                      <td
                                        style="
                                          ...
                                          "
                                        id="esd-menu-id-1" esdev-border-color="#3d5ca3" width="33.33%" valign="top" bgcolor="transparent" align="center">
                                      ...
                                      <td
                                        style="
                                            ...
                                            border-left: 1px solid #eceef6;
                                          "
                                        id="esd-menu-id-2" esdev-border-color="#3d5ca3" width="33.33%" valign="top" bgcolor="transparent" align="center">
