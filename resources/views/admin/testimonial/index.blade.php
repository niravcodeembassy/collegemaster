...
<div class="row d-flex mb-2">
  <div class="d-flex justify-content-between align-items-center col">
    <h4>{{ $title }}</h4>
    <div>
      <a href="{{ route('admin.testimonial.create') }}" class="btn btn-secondary btn-sm">
...
<div class="row">
  <div class="col-md-12">
    <div class="card p-0">
      <table class="table w-100" id="testimonialTable" data-url="{{ route('admin.testimonial.dataList') }}">
        <thead class="bg-light">
          <tr>
            <th style="width:40%" data-orderable="true">Name</th>
...
<script type="text/javascript">
  $(document).ready(function () {
        var table = $('#testimonialTable').DataTable({
            ...
            // "iDisplayLength": 2,
            "ajax": {
                "url": $('#testimonialTable').attr('data-url'),
                "dataType": "json",
                "type": "POST",
                "data": function (d) {
                    return $.extend({}, d, {});
