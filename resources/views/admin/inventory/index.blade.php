...
<form action="{{ route('admin.inventory.store') }}" method="post">
    ...
    <button class="showHideBulkEdit d-none btn btn-secondary btn-sm btn-rounded mr-3" type="submit"> <i
            class="fa fa-edit  "></i> Bulk Edit</button>
    <button class="btn float-right btn-sm btn-primary" data-target="#my-collapse" data-toggle="collapse" aria-expanded="false"
    aria-controls="my-collapse" type="button"><i class="fa fas fa-filter"></i></button>
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class=" col-12 col-sm-4">
                                        <select class="form-control input-sm category-select2" name="category" id="category"
                                    ...
                                    <div class=" col-12 col-sm-4 ">
                                        <a name="applyfilter" id="applyfilter"
                                            class="btn btn applyfilter btn-group-vertical btn-primary" href="#" role="button">Apply</a>
                                        <a name="clearfilter" id="clearfilter" class="btn btn clearfilter btn-group-vertical btn-default"
                                            href="#" role="button">Clear</a>
                                    </div>
                                </div>
