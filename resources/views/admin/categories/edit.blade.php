...
@section('content')
    <div class="row d-flex">
        <div class="d-flex justify-content-between align-items-center col">
            <h4>Edit Category</h4>
            <a href="{{ route('admin.category.index') }}" class="btn btn-secondary btn-sm"><i class="fa fa-arrow-left"></i>
                Back
            </a>
        </div>
    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name"
                                                data-rule-remote="{{ route('admin.category.exists', ['id' => $category->id]) }}"
                                                x-model="name" value="{{ $category->name ?? '' }}"
                                                data-msg-remote="Category is already exist." id="name" required
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly x-model="slug(name)"
                                                value="{{ $category->slug ?? '' }}" name="slug" required id="slug"
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="description" class="ckeditor form-control col-12" name="description" data-rule-required="false"
                                                data-msg-ckdata="Description is required." rows="3">{{ $category->description ?? '' }}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control html-editor" rows="4" name="meta_description">{{ $category->meta_description ?? '' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control html-editor" rows="4" name="meta_keywords">{{ $category->meta_keywords ?? '' }}</textarea>
                                        </div>
                                    </div>
                                </div>
