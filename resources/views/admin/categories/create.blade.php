                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" data-rule-remote="{{ route('admin.category.exists') }}"
                                                name="name" x-model="name" data-msg-remote="Category is already exist."
                    ...
                    <div class="col-sm-12 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p style="color: #999;">Add a title and decription to see how this category might appear in
                                    a search
                                    engine
                                    listing.</p>
