                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" data-rule-remote="{{ route('admin.category.exists') }}" name="name" x-model="name" data-msg-remote="Category is already exist." id="name" required class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-12 clearfix ">
                    @include('component.imagepriview', ['height' => '200px', 'label' => 'Image', 'name' => 'images', 'priview' => $category->image_src ?? null])
                  </div>
