<div class="modal fade" id="addcategory" tabindex="-1" role="dialog" aria-labelledby="addbrand" aria-hidden="true">
        <div class="modal-dialog  modal-md" role="document">
            <form action="{{ route('admin.option.update' , ['option' => $option->id ]) }}" method="POST" id="optiondform" name="optiondform" enctype="multipart/form-data">
                @csrf()
                @method('PUT')
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true"  data-msg-required="Attributes is required." >&times;</span></button>
                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input id="name" class="form-control" value="{{ $option->name ??  '' }}"
                                                   data-rule-remote="{{ route('admin.option.exists' , ['id' => $option->id] ) }}"
