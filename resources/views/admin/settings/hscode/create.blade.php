                            ...
                            <div class="form-row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input id="name" class="form-control"
                                               data-rule-remote="{{ route('admin.hscode.exists') }}"
                                               data-msg-remote="HSN code is already exists"
                                               type="text" name="name"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input id="percentage" class="form-control" value="{{ $hscode->percentage ??  '' }}" data-rule-number="true"
                                            type="text" name="percentage" min="1" max="100" data-rule-required="true">
                                    </div>
                                </div>
                            </div>
                        </div>
