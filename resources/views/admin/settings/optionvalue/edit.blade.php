<div class="modal fade" id="addcategory" role="dialog" aria-labelledby="addcategory" aria-hidden="true">
    <div class="modal-dialog" permission="document">
        <form name="optionvalueForm" id="optionvalueForm" method="post"
            ...
            action="{{route('admin.optionvalue.update' , $optionvalue->id) }} ">
            @csrf @method('PUT')

            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        Edit Attribute Vlaue </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group m-form__group">
                        <label for="option_id" class="form-control-label">Attribute : <i class="text-danger">*</i></label>
                        <select name="option_id" data-rule-required="false" data-placeholder="Select Attribute"
                            ...
                            @if($optionvalue->option)
                               <option value="{{ $optionvalue->option->id }}" selected>{{ $optionvalue->option->name }}</option>
                            @endif
                        </select>
                    </div>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <input type="text" class="form-control" id="option_value" name="option_value"
                            data-msg-remote="Please enter unique attributes value" value="{{ $optionvalue->name }}" maxlength="190">
                    </div>
                </div>
