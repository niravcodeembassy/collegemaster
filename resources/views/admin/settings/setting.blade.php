            ...
            <form action="{{ route('admin.settings.store') }}" id="settingsForm" enctype="multipart/form-data" method="post">
                ...
                <div class="card ">
                    <div class="card-body">
                        <div class="row ">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input required id="store_name" value="{{ $setting->response->store_name ?? '' }}"
                                        class="form-control" type="text" name="store_name">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input required id="copyrights" value="{{ $setting->response->copyrights ?? '' }}"
                                        class="form-control" type="text" name="copyrights">
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input required id="title" value="{{ $setting->response->meta_title ?? '' }}"
                                        class="form-control form-control-solid" type="text" name="meta_title">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="form-label fs-6 fw-bolder mb-3" for="keyword">Meta Keyword <span
                                            class="text-danger">*</span></label>
                                    <input required id="keyword" value="{{ $setting->response->meta_keywords ?? '' }}"
                                        class="form-control form-control-solid" type="text" name="meta_keywords">
                                </div>
                            </div>

                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="form-label fs-6 fw-bolder mb-3" for="description">Meta Description <span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-12  ">
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control" type="text" name="facebook"
                                        value="{{ $setting->response->facebook ?? '' }}" placeholder="Recipient's text"
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control" value="{{ $setting->response->instagram ?? '' }}"
                                        type="text" name="instagram" placeholder="Recipient's text"
                                        aria-label="Recipient's ">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input class="form-control" type="text" name="whatsapp"
                                        value="{{ $setting->response->whatsapp ?? '' }}" placeholder="Recipient's text"
                                        aria-label="Recipient's ">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input class="form-control" type="text"
                                        value="{{ $setting->response->linkedin ?? '' }}" name="linkedin"
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control" type="text" name="twitter"
                                        value="{{ $setting->response->twitter ?? '' }}" placeholder="Recipient's text"
                                        aria-label="Recipient's ">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input class="form-control" type="text" name="pinterest"
                                        value="{{ $setting->response->pinterest ?? '' }}" placeholder="Recipient's text"
                                        aria-label="Recipient's ">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select class="form-control category-select2" multiple name="category[]"
                                        id="category" data-url="{{ route('admin.get.category') }}"
                                        data-placeholder="Select Category.">
                                        @if (isset($setting->response->category) && !is_null($setting->response->category))
                                            @foreach ($setting->response->category as $item)
                                                <option value="{{ $item }}" selected>
                                                    {{ \App\Category::find($item)->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="google_link"
                                        value="{{ $setting->response->google_link ?? '' }}" aria-label="Recipient's ">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="offertext">Trust Pilot Review <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="pilot_link"
                                        value="{{ $setting->response->pilot_link ?? '' }}" aria-label="Recipient's ">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="offertext">Esty Review <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="esty_link"
                                        value="{{ $setting->response->esty_link ?? '' }}" aria-label="Recipient's ">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row d-none">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="offer_info"
                                        value="{{ $setting->response->offer_info ?? '' }}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="offertext">Offer Info Link<span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="offer_info_link"
                                        value="{{ $setting->response->offer_info_link ?? '' }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-radio">
                                            ...
                                            <div class="radio radio-inline">
                                                <label>
                                                    <input type="radio" class="shipping-charge" data-target=".amount"
                                                        name="charge_type" checked value="amount">
                                                    <i class="helper"></i>Amount
                                                </label>
                                            </div>
                                            <div class="radio radio-inline">
                                                <label>
                                                    <input type="radio" name="charge_type" data-target=".percentage"
                                                        class="shipping-charge" value="percentage"
                                                        {{ $setting->charge_type == 'percentage' ? 'checked' : '' }}>
                                ...
                                <div class="form-row">
                                    <div class="col amount">
                                        <div class="form-group">
                                            <label for="shipping_amount">Shipping Amount <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <input id="shipping_amount"
                                                value="{{ $setting->response->shipping_amount ?? '' }}"
                                                class="form-control" type="number"
                                                data-msg-required="Shipping amount required." name="shipping_amount">
                                        </div>
                                    </div>
                                    <div class="col percentage d-none">
                                        <div class="form-group">
                                            <label for="shipping_percentage">Shipping Percentage (%) <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <input id="shipping_percentage"
                                                value="{{ $setting->shipping_percentage ?? '' }}" class="form-control"
                                                type="number" name="shipping_percentage"
                                                data-msg-required="Shipping percentage required.">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input id="free_shipping"
                                                value="{{ $setting->response->free_shipping ?? '' }}"
                                                class="form-control" type="number" name="free_shipping"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="processing_time" class="form-control" type="text"
                                        value="{{ $setting->response->processing_time ?? '' }}" name="processing_time">
                                </div>
                                <div class="form-group">
                                    <label for="delivery_days">Number Of Delivery Days </label>
                                    <input id="delivery_days" class="form-control" number="true" type="text"
                                        value="{{ $setting->response->delivery_days ?? '' }}" name="delivery_days">
                                </div>
                                <div class="form-group">
                                    <label for="courier_provider">Courier Provider</label>
                                    <input id="courier_provider" class="form-control" type="text"
                                        value="{{ $setting->response->courier_provider ?? '' }}" name="courier_provider">
                                </div>
                            ...
                            <div class="form-row w-100">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input id="order_prefix" class="form-control" type="text"
                                            value="{{ $setting->response->order_prefix ?? '' }}" name="order_prefix">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label for="order_suffix">Suffix </label>
                                        <input id="order_suffix" class="form-control" type="text" name="order_suffix"
                                            value="{{ $setting->response->order_suffix ?? '' }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row w-100">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input id="invoice_prefix" class="form-control" type="text"
                                            name="invoice_prefix" value="{{ $setting->response->invoice_prefix ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="last_number">Next Invoice Number </label>
                                        <input id="last_number" class="form-control" type="text" name="last_number"
                                            readonly="true"
                                            value="{{ isset($setting->response->invoice_no) ? $setting->response->invoice_no + 1 : 1 }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <p>
                                            <label class="m-radio">
                                                <input type="radio" class="forment" id="forment1" value="1"
                                                    {{ !empty($setting) && optional($setting->response)->forment == '1' ? 'checked' : '' }}
                                                    {{ empty($setting) ? 'checked' : '' }} name="forment" value="0"
                                                    checked="">
                                                Number Based(00001)
                                                <span></span>
                                            </label><br>
                                            ...
                                            <label class="m-radio">
                                                <input type="radio" class="measurement" id="forment2" name="forment"
                                                    value="2"
                                                    {{ !empty($setting) && optional($setting->response)->forment == '2' ? 'checked' : '' }}>
                                                Year Based(YYYY/00001)
                                                <span></span>
                                            </label><br>

                                            <label class="m-radio">
                                                <input type="radio" class="measurement " id="forment3" name="forment"
                                                    value="3"
                                                    {{ !empty($setting) && optional($setting->response)->forment == '3' ? 'checked' : '' }}>
                                                00001-YY
                                                <span></span>
                                            </label><br>

                                            <label class="m-radio">
                                                <input type="radio" class="measurement " id="forment4" name="forment"
                                                    value="4"
                                                    {{ !empty($setting) && optional($setting->response)->forment == '4' ? 'checked' : '' }}>
                                                00001/MM/YY
                                                <span></span>
                                            </label>
                                        </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="twilio_auth_sid"
                                        value="{{ $setting->response->twilio_auth_sid ?? '' }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="twilio_auth_token"
                                        value="{{ $setting->response->twilio_auth_token ?? '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="offertext">Twilio SMS Number <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="twilio_sms_form"
                                        value="{{ $setting->response->twilio_sms_form ?? '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="offertext">Twilio Whastapp Number <span
                                            class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="twilio_whatsapp_form"
                                        value="{{ $setting->response->twilio_whatsapp_form ?? '' }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="recaptcha_site_key"
                                        value="{{ $setting->response->recaptcha_site_key ?? '' }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="recaptcha_secret_key"
                                        value="{{ $setting->response->recaptcha_secret_key ?? '' }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-row w-100">
                                <div class="col">
                                    <div class="form-group d-none">
                                        ...
                                        <input type="text" name="trust_script" class="form-control" id="trust_script"
                                            value="{{ $setting->response->trust_script ?? '' }}">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="material-switch">
                                            ...
                                            <input id="is_active" name="is_active" type="checkbox" value="1"
                                                {{ isset($setting->response->is_active) && $setting->response->is_active == true ? 'checked' : '' }}>
                        ...
                        <hr style="margin: 15px -20px">
                        <div class="row">
                            <h5 class="mb-3"><strong>Home Page Section 1</strong></h5>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="form-label fs-6 fw-bolder mb-3" for="sec_one_title">Title</label>
                                    <input id="sec_one_title" value="{{ $setting->response->sec_one_title ?? '' }}"
                                        class="form-control form-control-solid" type="text" name="sec_one_title">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="form-label fs-6 fw-bolder mb-3"
                                        for="sec_one_description">Description</label>
                                    <textarea class="form-control form-control-solid" name="sec_one_description" id="sec_one_description"
                                        rows="3">{{ $setting->response->sec_one_description ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                        <hr style="margin: 15px -20px">
                        <div class="row">
                            <h5 class="mb-3"><strong>Home Page Section 2</strong></h5>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="form-label fs-6 fw-bolder mb-3" for="sec_two_title">Title</label>
                                    <input id="sec_two_title" value="{{ $setting->response->sec_two_title ?? '' }}"
                                        class="form-control form-control-solid" type="text" name="sec_two_title">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="form-label fs-6 fw-bolder mb-3"
                                        for="sec_two_description">Description</label>
                                    <textarea class="form-control form-control-solid" name="sec_two_description" id="sec_two_description"
                                        rows="3">{{ $setting->response->sec_two_description ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
