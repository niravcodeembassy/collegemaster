        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-2 clearfix ">
              @include('component.imagepriview',[ 'height' => '100px','label' => 'Logo' , 'name' => 'logo', 'id' =>
              'logo', 'priview' => $setting->logo ?? null ])
            </div>
            <div class="col-sm-12 col-md-2 clearfix ">
              @include('component.imagepriview',['height' => '100px','label' => 'Favicon' ,'name' =>'favicon' , 'id' =>
              'favicon', 'priview' => $setting->favicon ?? null ])
            </div>
          </div>
            ...
            <div class="col-sm-12">
              <div class="form-group">
                <label class="form-label fs-6 fw-bolder mb-3" for="description">Meta Description <span
                    class="text-danger">*</span></label>
                <textarea class="form-control form-control-solid" name="meta_description" id="description" required
                  rows="3">{{ $setting->response->meta_description ?? '' }}</textarea>
              </div>
            </div>
          </div>
          <hr style="margin: 15px -20px">
                ...
                <div class="form-group">
                  <div class="form-radio">
                    ...
                    <div class="radio radio-inline">
                      <label>
                        <input type="radio" class="shipping-charge" data-target=".amount" name="charge_type" checked
                          value="amount">
                    ...
                    <div class="radio radio-inline">
                      <label>
                        <input type="radio" name="charge_type" data-target=".percentage" class="shipping-charge"
                          value="percentage" {{ $setting->charge_type == 'percentage' ? 'checked' : '' }}>
              ...
              <div class="form-row">
                <div class="col amount">
                  <div class="form-group">
                    ...
                    <input id="shipping_amount" value="{{ $setting->response->shipping_amount ?? '' }}"
                      class="form-control" type="number" data-msg-required="Shipping amount required."
                ...
                <div class="col percentage d-none">
                  <div class="form-group">
                    ...
                    <input id="shipping_percentage" value="{{ $setting->shipping_percentage ?? '' }}"
                      class="form-control" type="number" name="shipping_percentage"
              ...
              <div class="form-row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <input id="free_shipping" value="{{ $setting->response->free_shipping ?? '' }}" class="form-control"
                      type="number" name="free_shipping" data-rule-number="true">
                  </div>
                </div>
              </div>
            ...
            <div class="form-row w-100">
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input id="invoice_prefix" class="form-control" type="text" name="invoice_prefix"
                    value="{{  $setting->response->invoice_prefix ?? '' }}">
                </div>
              </div>
              <div class="col-6">
                <div class="form-group">
                  <label for="last_number">Next Invoice Number </label>
                  <input id="last_number" class="form-control" type="text" name="last_number" readonly="true"
            ...
            <div class="form-row">
              <div class="col-12">
                <div class="form-group">
                  ...
                  <p>
                    <label class="m-radio">
                      <input type="radio" class="forment" id="forment1" value="1" {{(!empty($setting) &&
                        optional($setting->response)->forment =='1')?'checked':''}}
                      {{empty($setting)?'checked':''}} name="forment" value="0" checked="">
                      Number Based(00001)
                      <span></span>
                    </label><br>

                    <label class="m-radio">
                      <input type="radio" class="measurement" id="forment2" name="forment" value="2" {{(!empty($setting)
                        && optional($setting->response)->forment=='2')?'checked':''}}>
                      Year Based(YYYY/00001)
                      <span></span>
                    </label><br>

                    <label class="m-radio">
                      <input type="radio" class="measurement " id="forment3" name="forment" value="3"
                    ...
                    <label class="m-radio">
                      <input type="radio" class="measurement " id="forment4" name="forment" value="4"
              ...
              <div class="col ">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="term_condition"
                    name="term_condition">{{ $setting->response->term_condition ?? "" }}</textarea><br>
                  <label>
          ...
          <hr style="margin: 15px -20px">
          <div class="row">
            <h5 class="mb-3"><strong>Trust Piolt Details</strong></h5>
            <div class="form-row w-100">
              <div class="col">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="trust_box" rows="4"
                    name="trust_box">{{ $setting->response->trust_box ?? "" }}</textarea>
                </div>
