                        ...
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group">
                                     ...
                                     <textarea id="content" class="ckeditor form-control col-12"
                                    data-rule-ckdata="ck" name="content" data-rule-required="true" data-msg-ckdata="Title is required" rows="3">
                                    </textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input id="url_handle" class="form-control" type="text" name="url_handle" data-rule-required="true" data-msg-required="URL is required" data-rule-remote="{{ route('admin.pages.slug') }}"
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="col">
                                ...
                                <img src="{{ asset('storage/default/picture.png') }}" data-default="{{ asset('storage/default/picture.png') }}" class="w-100" id="preview">
                                </div><br>
                                <div class="form-group">
