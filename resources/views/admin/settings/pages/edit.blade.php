...
@section('content')
  ...
  <form action="{{ route('admin.pages.update', $page->id) }}" data-url="{{ route('admin.pages.slug') }}" method="POST" name="pageform" id="pageform" enctype="multipart/form-data" data-id="{{ $page->id }}">
    @csrf()
    @method('PUT')
            ...
            <div class="form-row">
              <div class="col">
                <div class="form-group">
                  ...
                  <input id="title" class="form-control" type="text" name="title" data-rule-required="true" data-msg-required="Title is required" value="{{ $page->title ?? '' }}">
                </div>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="col">
                <div class="form-group">
                  ...
                  <textarea id="short_content" class="form-control col-12" name="short_content" rows="3">{{ $page->short_content ?? '' }}</textarea>
                </div>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="col">
                <div class="form-group">
                  ...
                  <textarea id="content" class="ckeditor form-control col-12" data-rule-ckdata="ck" name="content" data-rule-required="true" data-msg-ckdata="Content is required." rows="3">{{ $page->bodyhtml ?? '' }}</textarea>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="form-row">
              <div class="col">
                <div class="form-group">
                  ...
                  <input id="page_title" class="form-control" type="text" name="page_title" value="{{ $page->page_title ?? '' }}">
                </div>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="col">
                <div class="form-group">
                  ...
                  <textarea class="form-control html-editor" rows="4" name="meta_description">{{ $page->meta_desc ?? '' }}</textarea>
                </div>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="col">
                <div class="form-group">
                  ...
                  <textarea class="form-control html-editor" rows="4" name="meta_keyword">{{ $page->meta_keywords ?? '' }}</textarea>
                </div>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="col">
                <div class="form-group">
                  ...
                  <input id="url_handle" class="form-control" type="text" name="url_handle" data-rule-required="true" data-msg-required="Url handle is required" value="{{ $page->handle ?? '' }}"
                    data-rule-remote="{{ route('admin.pages.slug', ['id' => $page->id]) }}" data-msg-remote="Handle is already exist." data-rule-required="false">
                </div>
              </div>
            </div>
          </div>
