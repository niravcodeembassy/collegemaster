        ...
        <div class="d-flex justify-content-end align-items-center col">
            <div>
                ...
                <a href="javascript:void(0)"
                   ...
                   data-url="{{ route('admin.shipping-country.create') }}"
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body p-0">
                    <table class="table table-valign-middle" id="optionvlauetable" data-url="{{ route('admin.shipping-country.list') }}" style="width: 100%;">
                            <thead class="bg-light">
                                <tr>
                                    <th style="width:1%">No</th>
                                    <th style="width:25%" data-orderable="true">Charge</th>
                                    <th style="width:25%" data-orderable="false">Country</th>
