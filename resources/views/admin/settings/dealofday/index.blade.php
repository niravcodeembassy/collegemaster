                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input id="title"
                                    class="form-control" type="text" value="{{ $day_of_deal->title }}"
                                    name="title">
                            </div>
                            <div class="form-group">
                                <label for="button_name">Button Name</label>
                                <input id="button_name"
                                    class="form-control" type="text" value="{{ $day_of_deal->btn_name }}"
                                    name="button_name">
                            </div>
                            <div class="form-group">
                                <label for="button_url">Button URL</label>
                                <input id="button_url"
                                    class="form-control" type="text" value="{{ $day_of_deal->btn_url }}"
                                    name="button_url">
                            </div>
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                <div class="input-group input-group-button">
                                    <select class="form-control buy-together-select2" name="deal_product"  id="deal_product" data-url="{{ route('admin.get.product') }}"  data-placeholder="Select Related Products." data-rule-required="false" data-msg-required="Product category is required." >
