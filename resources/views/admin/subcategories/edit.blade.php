                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" data-url="{{ route('admin.sub-category.exists') }}"
                      data-id="{{ $category->id }}" x-model="name" value="{{ $category->name ?? '' }}" id="name"
        ...
        <div class="col-sm-12 col-md-5">
          <div class="card">
            <div class="card-body">
              ...
              <p style="color: #999;">Add a title and decription to see how this sub category might appear in a search
                engine
                listing.</p>
