        ...
        <ul class="nav nav-pills nav-sidebar  flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.category.index') }}" class="nav-link  {{ Helper::isActive(['category.*']) }}">
                    <i class="px-1">
                        <svg aria-hidden="true" width="18" focusable="false" data-prefix="fad" data-icon="list-alt"
                            role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                            class="svg-inline--fa fa-list-alt fa-2x">
                            <g class="fa-group">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.product.index') }}" class="nav-link  {{ Helper::isActive(['product.*']) }}">
                    <i class="px-1">
                        <svg aria-hidden="true" width="18" focusable="false" data-prefix="fad"
                            data-icon="bags-shopping" role="img" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 576 512" class="svg-inline--fa fa-bags-shopping fa-w-18 fa-2x">
                            <g class="fa-group">
                                <path fill="currentColor"
            ...
            <li class="nav-item">
                <a href="{{ route('admin.inventory.index') }}"
                    class="nav-link  {{ Helper::isActive(['inventory.*']) }}">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.customer.index') }}"
                    class="nav-link  {{ Helper::isActive(['customer.*']) }}">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.google-merchant.index') }}"
                    class="nav-link  {{ Helper::isActive(['google-merchant.*']) }}">
                    <i class="px-1  nav-icon f-18 fas fa-store d-inline-block"></i>
                    <p class="align-middle">
                        Google Merchant
                    </p>
                </a>
            ...
            <li class="nav-item">
                <a href="{{ route('admin.testimonial.index') }}"
                    class="nav-link  {{ Helper::isActive(['testimonial.*']) }}">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.order.index', ['type' => 'online']) }}"
                    ...
                    <p class="align-middle">
                        Order <span
                            class="badge badge-sm badge-danger mx-2 p-1 text-center">{{ $order }}</span>
                    </p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('admin.chat.order') }}"
                    class="nav-link  {{ Helper::isActive(['admin.chat.order']) }}">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.discount.index') }}"
                    class="nav-link  {{ Helper::isActive(['discount.*']) }}">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.website-setting') }}"
                    class="nav-link  {{ Helper::isActive(['website-setting']) }}">
