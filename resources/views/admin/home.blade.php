    ...
    <div class="col-md-6 mt-2">
      <div class="card card-primary collapsed-card">
        ...
        <div class="card-body" style="display:none">
          ...
          <canvas id="size_pie_chart" style="min-height: 300px; height: 300px; max-height: 300px; max-width: 100%; display: block; width: 764px;" class="chartjs-render-monitor"></canvas>
        </div>
      </div>
      <div class="card card-primary collapsed-card">
        <div class="card-header">
        ...
        <div class="card-body" style="display:none">
          ...
          <canvas id="variant_pie_chart" style="min-height: 300px; height: 300px; max-height: 300px; max-width: 100%; display: block; width: 764px;" class="chartjs-render-monitor"></canvas>
          </canvas>
        </div>
      </div>
      <div class="card card-primary collapsed-card">
    ...
    <div class="col-md-6 mt-2">
      ...
      <div class="card card-primary collapsed-card">
        ...
        <div class="card-body" style="display:none">
          ...
          <canvas id="material_pie_chart" style="min-height: 300px; height: 300px; max-height: 300px; max-width: 100%; display: block; width: 764px;" class="chartjs-render-monitor"></canvas>
          </canvas>
        </div>
      </div>
      <div class="card card-primary collapsed-card">
        ...
        <div class="card-body" style="display:none">
          ...
          <canvas id="country_pie_chart" style="min-height: 300px; height: 300px; max-height: 300px; max-width: 100%; display: block; width: 764px;" class="chartjs-render-monitor"></canvas>
          </canvas>
        </div>
      </div>
      <div class="card card-primary collapsed-card">
