...
@section('content')
  ...
  <form action="{{ route('admin.product.store') }}" enctype="multipart/form-data" method="POST" name="product_form" id="product_form" autocomplete="off">
    @csrf
    <div class="row">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input id="title" class="form-control" type="text" name="title" data-msg-required="Product title is required." data-rule-required="true">
            </div>

            <div class="form-group min">
              <div class="form-group">
                <label for="short_content">Short Description </label>
                <textarea id="short_content" class="ckeditor form-control col-12" name="short_content" data-rule-required="false" data-msg-ckdata="Description is required." rows="3">
                            </textarea>
              </div>
            </div>
            <div class="form-group">
              <div class="form-group">
                ...
                <textarea id="content" class="ckeditor form-control col-12" name="content" data-rule-required="true" data-msg-ckdata="Content is required." rows="3">
                            </textarea>
              </div>
            </div>
            <div class="form-group min">
              <div class="form-group">
                ...
                <textarea id="additional_description" data-rule-required="false" data-msg-ckdata="Additional Description is required." class="ckeditor form-control col-12" name="additional_description" rows="2">
              </textarea>
              </div>
            </div>
          </div>
            ...
            <div class="form-row">
              ...
              <div class="col">
                <div class="form-group">
                  ...
                  <input id="mrp_amount" class="form-control" type="text" name="mrp_amount" data-rule-required="true" data-msg-required="MRP  is required." data-rule-number="true">
                </div>
              </div>
              <div class="col">
                <div class="form-group">
              ...
              <div class="col">
                <div class="form-group">
                  ...
                  <input id="sku" class="form-control" value="{{ $product->sku ?? '' }}" type="text" name="sku" data-rule-required="false">
                </div>
              </div>
              <div class="col">
                <div class="form-group ">
                  <label for="taxable_percentage">HSN Code</label>
                  <select class="form-control hsncode-select2" name="taxable_percentage" id="taxable_percentage" data-url="{{ route('admin.get.taxable_percentage') }}" data-rule-required="false" data-placeholder="Select HSN Code">
              ...
              <div class="d-none">
                <div class="form-group">
                  ...
                  <input id="taxable_price" value="0.00" readonly class="form-control" type="text" name="taxable_price" data-rule-required="false">
                </div>
              </div>
            ...
            <div class="form-row">
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <input id="meta_keywords" class="form-control" type="text" name="meta_keywords" data-rule-required="false">
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <input id="meta_slug" class="form-control" type="text" name="meta_slug" data-rule-required="true" data-msg-required="URL is required" data-rule-remote="{{ route('admin.product.slug') }}"
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <div class="input-group input-group-button">
                    <select class="form-control category-select2" name="category" id="category" data-url="{{ route('admin.get.category') }}" data-rule-required="true" data-placeholder="Select Product Category."
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <div class="input-group input-group-button">
                    <select class="form-control sub-category-select2" name="sub_category" id="sub-category" data-url="{{ route('admin.get.sub-category') }}" data-target="#category" data-rule-required="true"
                      data-placeholder="Select Product Sub Category." data-msg-required="Product Sub category is required.">
            ...
            <div class="row">
              <div class="col-12">
                <div class="form-group mb-3">
                  <div class="input-group input-group-button">
                    <select class="form-control buy-together-select2" name="buy_to_together[]" multiple id="buy_to_together" data-url="{{ route('admin.get.search.product') }}" data-placeholder="Select Related Products." data-rule-required="false"
                      data-msg-required="Product category is required.">
            ...
            <div class="form-row">
              ...
              <div class="col">
                <div class="form-group">
                  ...
                  <input id="quantity" class="form-control" type="text" name="quantity" data-rule-required="false" value="1">
                </div>
              </div>
            ...
            <div class="form-row">
              ...
              <div class="col">
                <div class="form-group">
                  ...
                  <input id="attachment" class="form-control" value="1" type="text" name="attachment" data-rule-required="false" value=0">
                </div>
              </div>
