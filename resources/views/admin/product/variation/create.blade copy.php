    ...
    <form action="{{ route('admin.variation.store' , ['product_id' => $product->id ]) }}" id="variation_form" name="variation_form" class="repeater" method="post">
                                ...
                                <div class="form-row mt-15">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="option_name" id="option_name" 
                                                class="form-control optionnameselect2 text-lowercase"
                                                data-rule-required="true" 
                                                data-placeholder="Select Option name"
                                                data-url="{{ route('admin.get.option') }}">
                                                <option value=""></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            {{-- <a data-repeater-delete class="btn btn-delelt-item btn-danger shdow" value="Delete"/><i class="ik ik-trash ik-2x text-white"></i></a> --}}
                                        </div>
                                    </div>
                                </div>
                                <hr>
                ...
                <div class="card table-card hidden">
                    <div class="card-block table-responsive">
                        <table class="table table-hover mb-0 ">
                            ...
                            <tr>
                                <td class="w-5"></td>
                                <td class="w-25">Variants</td>
                                <td class="w-20">MRP </td>
                                <td class="w-20">Offer Price</td>
        ...
        <div class="row">
            ...
            <div class="col d-flex justify-content-end">
                <a href="{{route('admin.product.index')}}" name="submit" value="save_exit" class="btn btn-default btn-sm "><i class="ik ik-x"></i> Exit
                </a>&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td class="align-middle">
                    <div class="form-group mb-0">
                        <input type="text" class="form-control required"
                               data-rule-required="true"
                               {{-- data-msg-required="MRP  is required." --}}
                               data-msg-required=" "
                               data-rule-number="true"
                               data-rule-number="true"
                               data-id="mrp_price" name="variant_price[]" value="{{ $product->productdefaultvariant->mrp_price ?? '0.00' }}" placeholder="">
                    </div>
                </td>
                <td class="align-middle">
                    <div class="form-group mb-0">

                        <input type="text" class="form-control mb-0 required" data-id="Offer_price"
                               data-rule-required="true"
                               {{-- data-msg-required="Offer Price is required." --}}
                               data-msg-required=" "
                               value="{{ $product->productdefaultvariant->offer_price ?? '0.00' }}"
                               name="variant_cmp_price[]"
                               placeholder="">
                ...
                <td class="align-middle">
                    <div class="form-group mb-0">
                        <div class="">
                            <div >
                                <img src="{{ asset('storage/default/default.png') }}" data-toggle="modal" data-target="#my-modal" alt="" class="w-100 border  rounded shadow-sm card-img-top" style="height:35px"
                                     srcset="">
                ...
                <td class="align-middle">
                    <div class="form-group mb-0">
                        <input type="text" class="form-control mb-0 required"
                               data-rule-required="true"
                               data-msg-required=" "
                               data-id="variant_inventory" name="variant_inventory[]"
                               value="{{ $product->productdefaultvariant->inventory_quantity ?? '0.00' }}"
                               placeholder="">
                    </div>
                </td>
            </tr>
                        ...
                        @if ($product->images->count() > 0)
                            @foreach ($product->images as $item)
                                <div class="col-3 mb-3" id="select-image-{{$item->id}}">
                                    <i class="ikpos ik ik-check-circle hidden"></i>
