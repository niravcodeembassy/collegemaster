<div class="modal fade edit-layout-modal pr-0" id="editLayoutItem" tabindex="-1" role="dialog"
    ...
    <form
        action="{{ route('admin.variation.variation_update_form' , [ 'product_id' => $product->id , 'id' => $productvariant->id ]) }}" id="variantformeditform" method="post" enctype="multipart/form-data" data-id="{{ $productvariant->id }}">
        @csrf
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editLayoutItemLabel">Edit Variant</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="col-lg-6 col-md-12 px-sm-3 px-2">

                            <h6 class="text-mute"><strong>Variation</strong></h6>
                            <hr>

                            @if ($productvariant->variantCombination->count() > 0)

                                @foreach ($productvariant->variantCombination as $key => $combination_item)
                                    <div class="form-group mb-2">

                                        <label for="option_{{$key}}">{{ $combination_item->option->name }} <span class="text-danger">*</span></label>

                                        <input id="option_{{$key}}" class="form-control"
                                            value="{{ $combination_item->optionvalue->name }}" type="text" name="option[]"
                                            data-rule-required="true"
                                            data-msg-required="{{ $combination_item->option->name }} is required.">
                                    </div>
                                    <input type="hidden" name="option_id[]" value="{{ $combination_item->option->id }}">
                                    <input type="hidden" name="optionvalue_id[]" value="{{ $combination_item->optionvalue->id }}">
                                @endforeach
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <input id="mrp_amount" class="form-control" data-rule-required="true"
                                        ...
                                        value="{{ $productvariant->mrp_price ?? '' }}" name="mrp_amount">
                                </div>
                                <div class="form-group col">
                            ...
                            <div class="form-group">
                                ...
                                <input id="my-input" class="form-control" data-rule-required="true"
                                    ...
                                    name="inventory_quantity" value="{{ $productvariant->inventory_quantity ?? '1' }}">
                            </div>
                                ...
                                <div class="card-body border">
                                    ...
                                    <div class="form-group">
                                        <div class="text-center">
                                            <img src="{{  $productvariant->image->variant_image }}"
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="justify-content-center d-flex mb-2">
                                                ...
                                                <input type="hidden" id="image_id" name="image_id" value="{{ $productvariant->image->id ?? ''}}">
        ...
        $('#variantformeditform').validate({
            ...
            submitHandler: function (form , e) {
                ...
                .done(function(res){
                    ...
                    $('#data-cell-'+id).replaceWith(res.html);
