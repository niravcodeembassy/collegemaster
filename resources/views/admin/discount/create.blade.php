...
<div class="section">
    ...
    <form action="{{ route('admin.discount.store') }}"
          id="discountforms" name="discountforms" method="POST"
                        ...
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input id="discount_code" class="form-control text text-uppercase" type="text" name="discount_code"
                            ...
                            <div class="col">
                                ...
                                <div class="applies-to-option">
                                    <div class="d-none applies-to-product">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control discount-product-select2" style="width:100%;" name="applies_to_product[]" multiple id="applies_to_product" data-url="{{ route('admin.get.product') }}"  data-placeholder="Select Discount Product." data-rule-required="true"  data-msg-required="Discount Product is required." >
                                            </select>
                                        </div>
                                    </div>
                                </div>
