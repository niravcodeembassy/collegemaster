...
@section('content')
  ...
  <div class="section">
    ...
    <form action="{{ route('admin.discount.update', $coupon->id) }}" id="discountforms" name="discountforms" method="POST" data-id="{{ $coupon->id ?? 0 }}" data-url="{{ route('admin.discount.checkDiscountCode') }}">
      @csrf()
      @method('PUT')
      @php
              ...
              <div class="form-row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <a href="javascript:void(0);" class="float-right pb-2 text-primary generate-code" role="button">Generate
                      code</a>
                    <input id="discount_code" class="form-control text text-uppercase" value="{{ $coupon->discount_code ?? '' }}" type="text" name="discount_code" data-rule-required="true">
                  </div>
                    ...
                    <div class="form-group">
                      <div class="form-radio">
                        <div class="radio radio-inline">
                          <label>
                            <input type="radio" data-target=".amount" name="discount_type" class="shipping-charge" value="amount" {{ $amount }}>
                        ...
                        <div class="radio radio-inline">
                          <label>
                            <input type="radio" data-target=".percentage" class="shipping-charge" name="discount_type" value="percentage" {{ $percentage }}>
                ...
                <div class="col discount-type-option">
                  ...
                  <div class="{{ $amountShowHide }} amount">
                    <div class="form-group">
                      ...
                      <input type="text" id="amount" name="amount" class="form-control" value="{{ $coupon->discount_type == 'amount' ? $coupon->discount : '' }}" data-rule-required="true" min="0" placeholder="Discount in amount">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col">
                  <div class="form-group">
                    <label class="custom-control custom-radio">
                      <input type="radio" class="custom-control-input applies-to" {{ $entire_order ?? '' }} name="applies_to" value="entire_order">
                      <span class="custom-control-label">&nbsp;Entire order</span>
                    </label>
                  </div>
                  <div class="form-group">
                    <label class="custom-control custom-radio">
                      <input type="radio" class="custom-control-input applies-to" {{ $entire_product ?? '' }} data-target=".applies-to-product" name="applies_to" value="product">
                  ...
                  <div class="form-group d-none">
                    <label class="custom-control custom-radio">
                      <input type="radio" class="custom-control-input applies-to" {{ $entire_category ?? '' }} name="applies_to" data-target=".applies-to-category" value="category">
                  ...
                  <div class="applies-to-option d-none">
                    <div class="{{ $entire_category_showhide ?? 'd-none' }} applies-to-category">
                      ...
                      <div class="form-group">
                        <select class="form-control category-select2" style="width:100%;" name="applies_to_category[]" id="applies_to_category" data-url="{{ route('admin.get.category') }}" data-rule-required="true"
                          data-placeholder="Select Product Category." multiple data-msg-required="Product category is required.">
            ...
            <div class="card-body">
              ...
              <div class="form-row">
                <div class="col">
                  <div class="form-group">
                    <label class="custom-control custom-radio">
                      <input type="radio" class="custom-control-input minimum-requirement" {{ $requirement_none ?? '' }} name="minimum_requirement" value="none">
                      <span class="custom-control-label">&nbsp;None</span>
                    </label>
                  </div>
                  <div class="form-group">
                    <label class="custom-control custom-radio">
                      <input type="radio" class="custom-control-input minimum-requirement" {{ $requirement_amount ?? '' }} name="minimum_requirement" value="purchase_amount" data-target=".purchase-amount">
                  ...
                  <div class="minimum-requirement-option">
                    <div class="{{ $requirement_amount_showhide ?? 'd-none' }} purchase-amount">
                      <div class="form-group">
                        <input type="text" class="form-control" placeholder="Purchase amount" name="min_purchase_amount" id="min_purchase_amount" aria-describedby="helpId" data-rule-required="true" placeholder=""
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="input-group date" id="start_date" data-target-input="nearest" style="margin-bottom: 0px;">
                        <input type="text" class="form-control datetimepicker-input" id="start_date" onkeydown="return false;" value="{{ $coupon->start_date->format('d-m-Y h:i') }}" name="start_date" data-target="#start_date"
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="input-group date" id="end_date" data-target-input="nearest" style="margin-bottom: 0px;">
                        <input type="text" class="form-control datetimepicker-input" id="end_date" name="end_date" onkeydown="return false;" value="{{ $coupon->end_date->format('d-m-Y h:i') }}" data-target="#end_date"
                          data-rule-required="true" />
