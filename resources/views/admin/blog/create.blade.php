              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" data-rule-remote="{{ route('admin.blog.exists') }}" name="title" x-model="title"
                      id="title" data-msg-remote="Blog is already exist." required class="form-control">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" readonly x-model="slug(title)" name="slug" required id="slug"
                      class="form-control">
                  </div>
                </div>
                  ...
                  <div class="form-group min">
                    <div class="form-group">
                      ...
                      <textarea id="description" class="ckeditor form-control col-12" name="description"
                        data-rule-required="false" data-msg-ckdata="Description is required." rows="5">
                      </textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-12 clearfix ">
                  ...
                  [ 'height' => '200px','label' => 'Image' ,'name' =>'images','priview' => $blog->image_src ?? null ])
                </div>
