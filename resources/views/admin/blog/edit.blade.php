...
<div class="row mt-2">
  ...
  <div class="col-md-12">
    <form action="{{ route('admin.blog.update' , $blog->id ) }}" id="blogForm" method="post"
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="title"
                      data-rule-remote="{{ route('admin.blog.exists' ,['id' => $blog->id ]) }}" x-model="title"
                      value="{{ $blog->title ?? '' }}" data-msg-remote="Blog is already exist." id="title" required
                      class="form-control">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" readonly x-model="slug(title)" value="{{ $blog->slug ?? '' }}" name="slug"
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select name="tag[]" data-rule-required="true" multiple data-url="{{ route('admin.get.tag') }}"
                      data-placeholder="Select Tag" id="tag" class="form-control">
                ...
                <div class="col-md-12">
                  <div class="form-group min">
                    <div class="form-group">
                      ...
                      <textarea id="description" class="ckeditor form-control col-12" name="description"
                        data-rule-required="false" data-msg-ckdata="Description is required." rows="4">
                        {!! $blog->description ?? '' !!}
                    </textarea>
                    </div>
                  </div>
                ...
                <div class="col-sm-12 clearfix ">
                  ...
                  [ 'height' => '200px','label' => 'Image' ,'name' =>'images','priview' => $blog->image_src ??
                  null ])
                </div>
