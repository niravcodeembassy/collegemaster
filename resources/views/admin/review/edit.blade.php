        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea name="message" id="message" rows="2"
                  class="form-control">{{ $review->message ?? ''}}</textarea>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>Rating</label>
                <input type="text" name="rating" id="rating" value="{{ $review->rating ?? ''}}" data-rule-number="true"
                  class="form-control">
              </div>
            </div>
                ...
                <div class="form-group">
                  <div class="input-group date" id="created_date" data-target-input="nearest"
                    ...
                    <input type="text" class="form-control datetimepicker-input" id="created_date" name="created_date"
                      onkeydown="return false;" value="{{date_format($review->created_at," d/m/Y H:i:s") }}"
