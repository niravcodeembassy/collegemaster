    ...
    <div class="col-md-8 mb-8">
        ...
        <ul class="list-group mb-3 shadow-none b-0">
            ...
            <li class="list-group-item d-flex justify-content-between lh-condensed">
                ...
                <div style="margin-left:20px">
                    ...
                    <div class="">
                        ...
                        <span class="text-muted">{{ $key }} : {{ $attribute }}</span> @if ( !$loop->last) @endif
            ...
            <ul class="list-group mb-3  b-0" style="border-bottom: 1px solid rgba(0,0,0,.125)">
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed"
                                ...
                                <div>
                                 @if($user->profile_image != null)
                                        <img width="35px" src='{{$user->profile_image}}' style="border-radius: 50px;box-shadow:0px 1px #888888"/>    
                                    @else
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed"
                    style="border-bottom: 0px;border-top:1px solid #e0e0e0">
                        ...
                        <form name="orderMsgForm" id="orderMsgForm">
                            ...
                            <div class="form-group">
                                <input type="file" class="form-control" name="attachment[]" id="attachment"
                                    style="padding:3px!important;display: none" multiple>
                                <span style="width:50px;position: absolute;left: 540px;top: 36px;font-weight:600" id="no_of_files">0 Files Attached</span>

                                <img id="msg_img" src="{{ asset('storage/chat_img/img_avatar.png') }}"
                                    style="width:50px;border-radius:50%;position: absolute;left: 614px;top: 36px;" />

                            </div>
                            <div class="form-group" style="display: flex">

                                <textarea class="form-control" name="message"
                                    placeholder="Write your query regarding to order..." cols="30" rows="10"
                                    required></textarea>

                            </div>
                            <button class="btn btn-md btn-info float-right" id="msg_send_btn" type="submit"> Send <i
                                    class="fa fa-paper-plane"></i></button> <br>
