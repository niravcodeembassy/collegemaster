      ...
      <div class="card">
        <div class="card-header">
          <ul class="nav">
            ...
            <li class="nav-item">
              {{-- <a href="{{ route('admin.order.index', ['type' => 'cod']) }}" class="nav-link p-0 px-2 {{ $type === 'cod' ? 'text-primary' : '' }}">COD</a> --}}
            ...
            <li class="nav-item ">
              {{-- <a href="{{ route('admin.order.index', ['type' => 'pending']) }}" class="nav-link p-0 px-2 {{ $type === 'pending' ? 'text-primary' : '' }}">Online pending</a> --}}
