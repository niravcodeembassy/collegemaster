                                        ...
                                        <tr>
                                            <td><span>{{ strtoupper($shipping_address->address_one) ?? '' }}</span><br>
                                                @if ($shipping_address->address_two)
                                                    <span>{{ strtoupper($shipping_address->address_two) ?? '' }}</span>
                                                    <br>
                                                @endif
                            ...
                            <div class="right_part">
                                        ...
                                        <table class="order-table invoice_tbl">
                                            <tr>
                                                <td class="w-12" colspan="1">
                                                    <img src="{{ $image_url ?? 'https://i.etsystatic.com/18954143/r/il/4d9459/2243517109/il_340x270.2243517109_k5dq.jpg' }}"
                                                        class="img_product">
                                                </td>
                                        ...
                                        <table class="order-table invoice_tbl">
                                            <tr>
                                                <td class="w-88 v-top" colspan="2" style="padding-left:94px;">
                                                    ...
                                                    <span class="pt-top pt-left">{{ $product->sku ?? '' }}</span>
                                                    <br />
                                                    @if (count($attributes) > 0)
                                                        <span class="pt-top"><b>Size :</b></span>
                                                        <span class="pt-top pt-left">{{ $attributes['size'] ?? '' }}
                                                            inches</span>
                                                        <br />
                                                        <span class="pt-top" style="width:25%"><b>Printing Options
                                                                :</b></span>
                                                        <span class="pt-top pt-left"
                                                            style="width:75%">{{ $attributes['printing options'] ?? '' }}</span>
                                                        <br />
                                                    @endif
                                                    @if (isset($data->gift_message) && $data->gift_message != '')
                                                        <span class="pt-top text-danger"
                                                            style="width:25%;font-size: 23px;"><b>Gift
                                                                message
                                                                :</b></span>
                                                        <span class="pt-top pt-left text-danger"
                                                            style="width:75%;font-size: 23px;">{{ $data->gift_message ?? 'N/A' }}</span>
                                                        <br />
                                                    @endif
                                                    @if (isset($data->optional_note) && $data->optional_note != '')
                                                        <span class="pt-top text-danger"
                                                            style="font-size: 23px;"><b>Note from buyer :</b></span>
                                                        <span class="pt-top pt-left text-danger"
                                ...
                                <div class="note" style="display: none">
                                    <div class="buyer">
                                        ...
                                        <table>
                                            <tr>
                                                <td> <span>I will send you photos and also display text soon Leena.
                                                        Thank you</span></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="mesage">
                                        ...
                                        <table class="invoice_tbl">
                                            <tr>
                                                <td><span>{{ $order->gift ?? 'The most wonderful thing I decided to do was to share my life and heart with you.' }}</span>
                                                </td>
                                            </tr>
                                            <tr>
